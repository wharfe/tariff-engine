// tests/chapter-33.test.ts
// A/B comparison test: Chapter 33 accuracy with and without rules.

import { describe, it, expect, beforeAll, afterAll } from "vitest";
import { classify, loadTree } from "../src/classifier.js";
import { loadRules, clearRules } from "../src/rule-applier.js";
import testCases from "./fixtures/chapter-33-cases.json";
...
])("Chapter 33 accuracy ($label)", ({ label, useRules }) => {
  beforeAll(() => {
    loadTree();
    clearRules();
    if (useRules) {
